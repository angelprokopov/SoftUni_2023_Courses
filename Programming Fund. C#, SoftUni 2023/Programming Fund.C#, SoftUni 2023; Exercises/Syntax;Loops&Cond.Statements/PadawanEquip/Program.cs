...
namespace PadawanEquip
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (totalPrice > money) { Console.WriteLine($"John will need {totalPrice - money:f2}lv more.");}
            else if (totalPrice <= money){ Console.WriteLine($"The money is enough - it would cost {totalPrice:f2}lv."); }
        }
    }
}
